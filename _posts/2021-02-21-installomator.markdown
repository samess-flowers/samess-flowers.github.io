...
and then when we click the **Install** button we get a spinning wheel on the button which updates from *Executing* to *Running* and then to *Finishing*,

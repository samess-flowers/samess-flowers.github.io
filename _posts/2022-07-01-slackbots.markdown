...
## Set-up
This is a brief tutorial to walk you start to finish from having no code to have a working Slackbot that responds to @mentions with the 👀 reaction in whatever channel you invite it to.  Along the way we'll get the code and config into source control, without getting our secrets in there.
